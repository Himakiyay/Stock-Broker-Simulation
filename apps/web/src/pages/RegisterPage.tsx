...
export default function RegisterPage() {
  ...
  const canSubmit = useMemo(() => {
    ...
    return u.length > 0 && password.length >= 6;
      ...
      <div style={styles.shell}>
        ...
        <div style={styles.left}>
          ...
          <p style={styles.heroSub}>
            Start with a paper cash balance and trade against a live simulated market.
          </p>

          <div style={styles.bullets}>
            <Bullet text="Instant portfolio + positions tracking" />
            <Bullet text="Live quote polling per symbol" />
            <Bullet text="Market history endpoint ready for sparklines" />
          </div>

          <div style={styles.smallNote}>
            Password must be at least <b>6 characters</b>.
          </div>
        </div>
        ...
        <div style={styles.right}>
          <div style={styles.card}>
            <div style={styles.cardHeader}>
              ...
              <div style={styles.cardSub}>Register and you’ll be logged in automatically.</div>
            </div>
            ...
            <form onSubmit={onSubmit} style={styles.form}>
              ...
              {!err && password.length > 0 && password.length < 6 && (
          ...
          <div style={styles.rightNote}>
            <span style={{ opacity: 0.75 }}>You’ll start with</span>{" "}
            <code style={styles.codePill}>$10,000</code>{" "}
            <span style={{ opacity: 0.75 }}>paper cash.</span>
          </div>
        </div>
      </div>
    </div>
